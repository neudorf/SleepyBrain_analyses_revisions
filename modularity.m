...
outputs_dir = [project_dir 'outputs/modularity/'];
mkdir(outputs_dir);
mod_table_filename = 'sleepybrain_modularity_res_0_5.csv';
FC_mat_filename = 'sleepybrain_FC_res_0_5.mat';
mod_mat_filename = 'sleepybrain_modularity_res_0_5.mat';
...
outputs_dir = [project_dir 'outputs/modularity/'];
mkdir(outputs_dir);
mod_table_filename = 'sleepybrain_modularity_res_0_75.csv';
FC_mat_filename = 'sleepybrain_FC_res_0_75.mat';
mod_mat_filename = 'sleepybrain_modularity_res_0_75.mat';
...
FC_community=[];
FC_M=[];
gamma = 0.75; % resolution parameter
n=220;
for s=1:length(young_subs_files) + length(old_subs_files)
    A_flat = ALL_SUBS{s};
    A_square = zeros(n);
...
outputs_dir = [project_dir 'outputs/modularity/'];
mkdir(outputs_dir);
mod_table_filename = 'sleepybrain_modularity_res_1_25.csv';
FC_mat_filename = 'sleepybrain_FC_res_1_25.mat';
mod_mat_filename = 'sleepybrain_modularity_res_1_25.mat';
...
FC_community=[];
FC_M=[];
gamma = 1.25; % resolution parameter
n=220;
for s=1:length(young_subs_files) + length(old_subs_files)
    A_flat = ALL_SUBS{s};
    A_square = zeros(n);
...
outputs_dir = [project_dir 'outputs/modularity/'];
mkdir(outputs_dir);
mod_table_filename = 'sleepybrain_modularity_res_1_5.csv';
FC_mat_filename = 'sleepybrain_FC_res_1_5.mat';
mod_mat_filename = 'sleepybrain_modularity_res_1_5.mat';
...
FC_community=[];
FC_M=[];
gamma = 1.5; % resolution parameter
n=220;
for s=1:length(young_subs_files) + length(old_subs_files)
    A_flat = ALL_SUBS{s};
    A_square = zeros(n);
