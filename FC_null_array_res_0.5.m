...
load(fullfile(mod_dir,'FC_community_res_0.5.mat'), 'FC_community');
load(fullfile(mod_dir,'ALL_SUBS_res_0.5.mat'), 'ALL_SUBS');
...
save(fullfile(mod_dir,sprintf('FC_Q_res_0.5_sub%d',subject_index)), 'pval');
save(fullfile(mod_dir,sprintf('FC_Q_res_0.5_null_distribution_sub%d', subject_index)), 'null_distribution');
save(fullfile(mod_dir,sprintf('FC_Q_res_0.5_null_matrices_sub%d', subject_index)), 'null_matrices');
