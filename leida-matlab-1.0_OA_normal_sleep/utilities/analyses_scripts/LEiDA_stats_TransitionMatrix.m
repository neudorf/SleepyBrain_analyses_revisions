...
if pair == 0
    save([data_dir '/' 'K' num2str(selectedK) '/' save_file],'TM','TMnorm','TM_pval','effectsize','levene_pval',...,
                              'cond','rangeK','file_cluster','file_V1','Index_Conditions')
else
    save([data_dir '/' 'K' num2str(selectedK) '/' save_file],'TM','TMnorm','TM_pval','effectsize',...,
                              'cond','rangeK','file_cluster','file_V1','Index_Conditions')
end
