function [] = LEiDA_AnalysisCentroid(LEiDA_directory, run_name, SelectK, Parcellation)
...
% JN comment: using for loop to do all centroids instead
% Centroid = 2;
...
%Parcellation = 'TVBSchaeferTian193';
