...
project_dir = '../';
LEiDA_directory = [project_dir 'leida-matlab-1.0_OA_deprived_sleep/'];
run_name = 'SleepyBrain_TVB_SchaeferTian_220';
Parcellation = 'TVBSchaeferTian220';
Conditions_tag = {'deprived_sleep','normal_sleep'};
n_permutations = 10000; % can keep as 500 testing, then increase to 10000
n_bootstraps = 500; % can keep as 10 for testing, then increase to 500
