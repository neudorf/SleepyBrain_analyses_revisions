...
#res param 0.75
#mod_file = here('outputs/modularity/sleepybrain_modularity_res_0_75.csv') #REPLACE FOR GITHUB
mod_file = ('/media/WDBlue/mcintosh/projects/SleepyBrain/rsfMRI_sleep_deprivation_FAIR_revisions/SleepyBrain_analyses_revisions/outputs/modularity/sleepybrain_modularity_res_0_75.csv') #REMOVE FOR GITHUB
mod_df = read.csv(mod_file,sep=',')
mod_df$sub = factor(mod_df$sub)
mod_df$age = factor(mod_df$age, levels = c('young','old'))
mod_df$sleep = factor(mod_df$sleep, levels = c('normal','deprived'))
...
cols = c('#444444','#2AA198','#D33682')
pdf("/media/WDBlue/mcintosh/projects/SleepyBrain/rsfMRI_sleep_deprivation_FAIR_revisions/SleepyBrain_analyses_revisions/outputs/modularity/Q_res_0_75.pdf", height = 6, width = 6) 
par(mar = c(4, 5, 1, 2))
plot(1, frame.plot = F, xlim = c(0, 1), ylim = c(.28,.38), xlab = "", ylab = "Modularity (Q)", xaxt = "n", type = "n")
axis(1, at = c(0.05, 0.95), labels = c("Normal Sleep", "Restricted Sleep"))
lines(x = c(0, 0.9), y = effect("sleep*age", lm)$fit[1:2], pch = 16, col = cols[3], type = "b", lwd = 1.5)
lines(x = c(0.1, 1), y = effect("sleep*age", lm)$fit[3:4], pch = 16, col = cols[2], type = "b", lwd = 1.5)
lines(x = c(0, 0), y = c(effect("sleep*age", lm)$lower[1], effect("sleep*age", lm)$upper[1]), col = cols[3], lwd = 1.5)
...
cols = c('#444444','#2AA198','#D33682')
pdf("/media/WDBlue/mcintosh/projects/SleepyBrain/rsfMRI_sleep_deprivation_FAIR_revisions/SleepyBrain_analyses_revisions/outputs/modularity/Q_motion_res_0_75.pdf", height = 6, width = 6) 
par(mar = c(4, 5, 1, 2))
plot(1, frame.plot = F, xlim = c(0, 1), ylim = c(.3,.38), xlab = "", ylab = "Modularity (Q)", xaxt = "n", type = "n")
axis(1, at = c(0.05, 0.95), labels = c("Normal Sleep", "Restricted Sleep"))
lines(x = c(0, 0.9), y = effect("sleep*age", lm4)$fit[1:2], pch = 16, col = cols[3], type = "b", lwd = 1.5)
lines(x = c(0.1, 1), y = effect("sleep*age", lm4)$fit[3:4], pch = 16, col = cols[2], type = "b", lwd = 1.5)
lines(x = c(0, 0), y = c(effect("sleep*age", lm4)$lower[1], effect("sleep*age", lm4)$upper[1]), col = cols[3], lwd = 1.5)
...
#res param 1.25
#mod_file = here('outputs/modularity/sleepybrain_modularity_res_1_25.csv') #REPLACE FOR GITHUB
mod_file = ('/media/WDBlue/mcintosh/projects/SleepyBrain/rsfMRI_sleep_deprivation_FAIR_revisions/SleepyBrain_analyses_revisions/outputs/modularity/sleepybrain_modularity_res_1_25.csv') #REMOVE FOR GITHUB
mod_df = read.csv(mod_file,sep=',')
mod_df$sub = factor(mod_df$sub)
mod_df$age = factor(mod_df$age, levels = c('young','old'))
mod_df$sleep = factor(mod_df$sleep, levels = c('normal','deprived'))
...
cols = c('#444444','#2AA198','#D33682')
pdf("/media/WDBlue/mcintosh/projects/SleepyBrain/rsfMRI_sleep_deprivation_FAIR_revisions/SleepyBrain_analyses_revisions/outputs/modularity/Q_res_1_25.pdf", height = 6, width = 6) 
par(mar = c(4, 5, 1, 2))
plot(1, frame.plot = F, xlim = c(0, 1), ylim = c(.12,.22), xlab = "", ylab = "Modularity (Q)", xaxt = "n", type = "n")
axis(1, at = c(0.05, 0.95), labels = c("Normal Sleep", "Restricted Sleep"))
lines(x = c(0, 0.9), y = effect("sleep*age", lm)$fit[1:2], pch = 16, col = cols[3], type = "b", lwd = 1.5)
lines(x = c(0.1, 1), y = effect("sleep*age", lm)$fit[3:4], pch = 16, col = cols[2], type = "b", lwd = 1.5)
lines(x = c(0, 0), y = c(effect("sleep*age", lm)$lower[1], effect("sleep*age", lm)$upper[1]), col = cols[3], lwd = 1.5)
...
cols = c('#444444','#2AA198','#D33682')
pdf("/media/WDBlue/mcintosh/projects/SleepyBrain/rsfMRI_sleep_deprivation_FAIR_revisions/SleepyBrain_analyses_revisions/outputs/modularity/Q_motion_res_1_25.pdf", height = 6, width = 6) 
par(mar = c(4, 5, 1, 2))
plot(1, frame.plot = F, xlim = c(0, 1), ylim = c(.12,.22), xlab = "", ylab = "Modularity (Q)", xaxt = "n", type = "n")
axis(1, at = c(0.05, 0.95), labels = c("Normal Sleep", "Restricted Sleep"))
lines(x = c(0, 0.9), y = effect("sleep*age", lm4)$fit[1:2], pch = 16, col = cols[3], type = "b", lwd = 1.5)
