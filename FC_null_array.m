...
% Load subjects and matrices
load(fullfile(mod_dir,'sleepybrain_modularity_res_0_5.mat'), 'FC_community');
load(fullfile(mod_dir,'sleepybrain_FC_res_0_5.mat'), 'ALL_SUBS');
...
parfor i = 1:num_nulls
    null_mat = null_model_und_sign(matrix);
    [null_M,null_Q] = community_louvain(null_mat,0.5,'','negative_asym');
    null_distribution(i)= null_Q;
    null_matrices{i}=null_mat;
end
...
save(fullfile(mod_dir,sprintf('FC_Q_res_0_5_sub%d',subject_index)), 'pval');
save(fullfile(mod_dir,sprintf('FC_Q_res_0_5_null_distribution_sub%d', subject_index)), 'null_distribution');
save(fullfile(mod_dir,sprintf('FC_Q_res_0_5_null_matrices_sub%d', subject_index)), 'null_matrices');
...
% Load subjects and matrices
load(fullfile(mod_dir,'sleepybrain_modularity_res_1_5.mat'), 'FC_community');
load(fullfile(mod_dir,'sleepybrain_FC_res_1_5.mat'), 'ALL_SUBS');
...
save(fullfile(mod_dir,sprintf('FC_Q_res_1_5_sub%d',subject_index)), 'pval');
save(fullfile(mod_dir,sprintf('FC_Q_res_1_5_null_distribution_sub%d', subject_index)), 'null_distribution');
save(fullfile(mod_dir,sprintf('FC_Q_res_1_5_null_matrices_sub%d', subject_index)), 'null_matrices');
