...
#hippocampus investigation
labels = pd.read_csv(ATLAS_NETWORK_LABELS_FILE,delimiter=',')
friendly_labels = pd.read_csv(ATLAS_FRIENDLY_NAMES_FILE,delimiter='\t',header=None,names=['x','y','z','weight1','weight2','region'])

#%% all hippocampus connections
print('hippocampus connections')
connected_regions_108 = np.where(FC_bsr_bin[107,:] > 0)
print('LH Hipp head 108:',connected_regions_108)
print(labels.iloc[connected_regions_108]['region'])
print(friendly_labels.iloc[connected_regions_108]['region'])
connected_regions_109 = np.where(FC_bsr_bin[108,:] > 0)
print('LH Hipp body 109:',connected_regions_109)
print(labels.iloc[connected_regions_109]['region'])
print(friendly_labels.iloc[connected_regions_109]['region'])
connected_regions_110 = np.where(FC_bsr_bin[109,:] > 0)
print('LH Hipp tail 110:',connected_regions_110)
print(labels.iloc[connected_regions_110]['region'])
print(friendly_labels.iloc[connected_regions_110]['region'])

connected_regions_218 = np.where(FC_bsr_bin[217,:] > 0)
print('RH Hipp head 218:',connected_regions_218)
print(labels.iloc[connected_regions_218]['region'])
print(friendly_labels.iloc[connected_regions_218]['region'])
connected_regions_219 = np.where(FC_bsr_bin[218,:] > 0)
print('RH Hipp body 219:',connected_regions_219)
print(labels.iloc[connected_regions_219]['region'])
print(friendly_labels.iloc[connected_regions_219]['region'])
connected_regions_220 = np.where(FC_bsr_bin[219,:] > 0)
print('RH Hipp tail 220:',connected_regions_220)
print(labels.iloc[connected_regions_220]['region'])
print(friendly_labels.iloc[connected_regions_220]['region'])

#%% positive hippocampus connections
print('positive hippocampus connections')
connected_regions_108 = np.where(FC_bsr[107,:] > pls_fig_thresh)
print('LH Hipp head 108:',connected_regions_108)
print(labels.iloc[connected_regions_108]['region'])
print(friendly_labels.iloc[connected_regions_108]['region'])
connected_regions_109 = np.where(FC_bsr[108,:]  > pls_fig_thresh)
print('LH Hipp body 109:',connected_regions_109)
print(labels.iloc[connected_regions_109]['region'])
print(friendly_labels.iloc[connected_regions_109]['region'])
connected_regions_110 = np.where(FC_bsr[109,:]  > pls_fig_thresh)
print('LH Hipp tail 110:',connected_regions_110)
print(labels.iloc[connected_regions_110]['region'])
print(friendly_labels.iloc[connected_regions_110]['region'])

connected_regions_218 = np.where(FC_bsr[217,:]  > pls_fig_thresh)
print('RH Hipp head 218:',connected_regions_218)
print(labels.iloc[connected_regions_218]['region'])
print(friendly_labels.iloc[connected_regions_218]['region'])
connected_regions_219 = np.where(FC_bsr[218,:]  > pls_fig_thresh)
print('RH Hipp body 219:',connected_regions_219)
print(labels.iloc[connected_regions_219]['region'])
print(friendly_labels.iloc[connected_regions_219]['region'])
connected_regions_220 = np.where(FC_bsr[219,:]  > pls_fig_thresh)
print('RH Hipp tail 220:',connected_regions_220)
print(labels.iloc[connected_regions_220]['region'])
print(friendly_labels.iloc[connected_regions_220]['region'])

#%% negative hippocampus connections
print('negative hippocampus connections')
connected_regions_108 = np.where(FC_bsr[107,:] < -1*pls_fig_thresh)
print('LH Hipp head 108:',connected_regions_108)
print(labels.iloc[connected_regions_108]['region'])
print(friendly_labels.iloc[connected_regions_108]['region'])
connected_regions_109 = np.where(FC_bsr[108,:] < -1*pls_fig_thresh)
print('LH Hipp body 109:',connected_regions_109)
print(labels.iloc[connected_regions_109]['region'])
print(friendly_labels.iloc[connected_regions_109]['region'])
connected_regions_110 = np.where(FC_bsr[109,:] < -1*pls_fig_thresh)
print('LH Hipp tail 110:',connected_regions_110)
print(labels.iloc[connected_regions_110]['region'])
print(friendly_labels.iloc[connected_regions_110]['region'])

connected_regions_218 = np.where(FC_bsr[217,:] < -1*pls_fig_thresh)
print('RH Hipp head 218:',connected_regions_218)
print(labels.iloc[connected_regions_218]['region'])
print(friendly_labels.iloc[connected_regions_218]['region'])
connected_regions_219 = np.where(FC_bsr[218,:] < -1*pls_fig_thresh)
print('RH Hipp body 219:',connected_regions_219)
print(labels.iloc[connected_regions_219]['region'])
print(friendly_labels.iloc[connected_regions_219]['region'])
connected_regions_220 = np.where(FC_bsr[219,:] < -1*pls_fig_thresh)
print('RH Hipp tail 220:',connected_regions_220)
print(labels.iloc[connected_regions_220]['region'])
print(friendly_labels.iloc[connected_regions_220]['region'])
